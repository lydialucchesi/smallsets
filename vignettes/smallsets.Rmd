...
The [following section](#Rexample) includes an example R preprocessing script with smallsets structured comments.
...
```{r timeline3, fig.width = 7, fig.height = 3, fig.retina = 2, fig.align='center'}
Smallset_Timeline(data = s_data, 
                  code = system.file("s_data_preprocess.R", package = "smallsets"), 
...
```{r timeline4, echo=FALSE, fig.width = 7, fig.height = 3, fig.retina = 2, fig.align='center'}
Smallset_Timeline(data = s_data,
                  code = system.file("s_data_preprocess.R", package = "smallsets"),
...
```{r timeline5, fig.width = 7, fig.height = 4, fig.retina = 2, fig.align='center'}
set.seed(145)
