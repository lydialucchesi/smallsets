...
Some differences: custom colour palette, data in the snapshots, highlighting missing data, a different font, no ghost data, and altered sizing, spacing, and labelling.
...
Some differences: four snapshots, use of a built-in colour palette, split into two rows, and rotated column names.
```{r timeline6, fig.width = 5, fig.height = 6, fig.retina = 2, fig.align='center'}
set.seed(145)
