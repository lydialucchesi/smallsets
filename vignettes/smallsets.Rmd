...
To use the other two selection methods, which are optimisation problems, you will need a Gurobi license as they rely on the Gurobi solver (version 9.1.2). A license can be obtained from https://www.gurobi.com. Free academic licenses are available.
