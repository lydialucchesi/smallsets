...
```{r timeline2, fig.width = 7, fig.height = 3, fig.align='center'}
Smallset_Timeline(data = s_data, 
                  code = system.file("s_data_preprocess.R", package = "smallsets"), 
...
```{r timeline3, echo=FALSE, fig.width = 7, fig.height = 3, fig.align='center'}
Smallset_Timeline(data = s_data,
                  code = system.file("s_data_preprocess.R", package = "smallsets"),
...
```{r timeline4, fig.width = 7, fig.height = 4, fig.align='center'}
set.seed(145)
...
```{r timeline5, fig.width = 5, fig.height = 6, fig.align='center'}
set.seed(145)
...
```{r timeline6, fig.width = 7, fig.height = 2, fig.align='center', fig.retina = 2}
set.seed(145)
