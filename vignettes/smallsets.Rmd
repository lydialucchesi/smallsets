...
<font size="4"> 
**# smallsets snap + <span style="color: red;">*place*</span> + <span style="color: red;">*name of data object*</span> + caption[<span style="color: red;">*text*</span>]caption**
</font>
...
Differences: custom colour palette, data in the snapshots, highlighting missing data, a different font, no ghost data, and altered sizing/spacing/labelling.
...
Differences: vertical alignment.
```{r timeline6, fig.width=5, fig.height = 5, fig.retina = 2, fig.align='center'}
set.seed(145)
...
Smallset_Timeline(
  ...
  code = system.file("s_data_preprocess.R", package = "smallsets"),
  align = "vertical",
  spacing = sets_spacing(captions = 8)
)
```

**Example 3**

Differences: four snapshots, use of the third built-in colour palette, split into two rows, and rotated column names.
